# Mi web del apartado de `symphony-examen`

---
- **Autor**: Samuel Aded
- **Profesor**: Víctor Ponz
- **Curso**: 2º CFGS de DAW (DWES - symphony-examen)
---
...
```bash
  composer create-project symfony/skeleton:"6.4.*" proyecto-examen
```
El comando anterior creará la carpeta del proyecto con el nombre `proyecto-examen`.
